            ...
            if (tokenNopecha) {
              ...
              try {
                await this.pagina.evaluate((token) => {
                  ...
                  // (b) Tenta chamar o callback registrado pelo hcaptcha widget
                  if (window.hcaptcha) {
                    try {
                      ...
                      containers.forEach((container) => {
                        ...
                        // Acessa estado interno do widget para invocar o callback
                        const state =
                          window.hcaptcha._state?.[widgetId] ||
                          window.hcaptcha._api?._state?.[widgetId];
                        const cb =
